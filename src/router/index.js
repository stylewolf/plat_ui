...
export const systemRouteMap = [
  {
    ...
    children: [
      { path: 'role', component: () => import('@/views/components-demo/tinymce'), name: 'role-anage', meta: { title: 'roleManage' }},
      { path: 'user', component: () => import('@/views/components-demo/markdown'), name: 'user-manage', meta: { title: 'userManage' }},
      { path: 'dept', component: () => import('@/views/components-demo/jsonEditor'), name: 'dept-manage', meta: { title: 'deptManage' }}
    ]
  }
]
// 电警菜单
export const policeRouteMap = [
  {
    path: '/icon',
    component: Layout,
    children: [{
...
// 高清菜单
export const hdvmRouteMap = [

]
// 诱导菜单
export const guideRouteMap = [
